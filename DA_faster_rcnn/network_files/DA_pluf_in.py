...
from .DA_LabelResizeLayer import (ImageLabelResizeLayer, InstanceLabelResizeLayer,)
from torch.autograd import Function, Variable

# 定义了三个类 GRLayer、_ImageDA、_InstanceDA、Discriminator
